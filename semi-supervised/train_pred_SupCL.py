...
dirname = f"./weights_pred_supCL/{dataset}/{config['ways']}way_{config['shot']}shot/{run}/"
...
master.loc[run] = [f"only_pred_supCL-{config['ways']}-{config['shot']}-{config['unlabelled']}", f"{dataset}-{split}", n_episodes, batch_size, 'No']
