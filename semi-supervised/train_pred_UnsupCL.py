...
dirname = f"./weights_pred_unsupCL/{dataset}/{config['ways']}way_{config['shot']}shot/{run}/"
...
master.loc[run] = [f"only_pred_unsupCL-{config['ways']}-{config['shot']}-{config['unlabelled']}", f"{dataset}-{split}", n_episodes, batch_size, 'No']
